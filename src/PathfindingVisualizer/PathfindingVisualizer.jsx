...
import Node from './compnents/Node';
...
export default class PathfindingVisualizer extends Component {
    ...
    render() {
        ...
        return (
            <div>
                {/* navbar-expand-lg text-green */}
                {/* <nav className="navbar navbar-expand-lg navbar-gray bg-gray-400 mx-40 "> */}
                <nav className="navbar bg-info mb-3 flex">
                    <div className="navtext font-bold">
